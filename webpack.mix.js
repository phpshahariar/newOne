...
const adminResourcesAssets = "resources/admin/";
...
mix.js('resources/frontend/js/app.js', 'js')
   ...
   .sass('resources/frontend/sass/navigation.scss', 'css')
   .sass('resources/frontend/sass/style.scss', 'css')
   .js('resources/admin/assets/js/app.js', 'admin/js/admin.js')
   .sass('resources/admin/assets/sass/app.scss', 'admin/css/admin.css');
