        ...
        <div class="container">
            <div class="row align-items-center mb-5 flex-columns">
                <div class="col-lg-7 pr-5 wow fadeInRight" data-wow-duration="0.8s">
                    ...
                    <a href="#" class="btn btn-dark btn-modern btn-outline rounded-0 py-2 px-4">join now <i class="fas fa-long-arrow-alt-right"></i></a>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center mb-5 column-reverses">
                ...
                <div class="col-lg-7 pr-5 wow fadeInRight" data-wow-duration="0.8s">
                    ...
                    <!-- <a href="javascript:void(0)" class="btn btn-default custom-btn page-scroll"><span>VIEW MORE</span> <i class="fas fa-long-arrow-alt-right"></i></a> -->
                    <a href="#" class="btn btn-dark btn-modern btn-outline rounded-0 py-2 px-4 float-right">join now <i class="fas fa-long-arrow-alt-right"></i></a>
                </div>
            </div>
        </div>
    </section>
