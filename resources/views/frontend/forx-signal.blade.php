    ...
    <section class="fx_tri">
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div id="accordion" class="faq_content left_menu">
                            <div class="card">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="card-body">
                                        <ul>
                                            <li class="active"><a href="fx-signal.html">All Signals</a></li>
                                            <li><a href="intra-signal.html">Intraday Signal</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 p-0 analysis-section">
                            <div class="panel panel-light panel-flat sig-tabs">
                                ...
                                <ul class="custum-nav-indicator nav nav-tabs nav-tabs-transparent indicator-primary nav-tabs-full nav-tabs-4 "
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a href="#Filled" aria-controls="Filled" role="tab" data-toggle="tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a href="#Canceled" aria-controls="Canceled" role="tab" data-toggle="tab"
                                           class="nav-link withoutripple">
                                            <i class="fa fa-area-chart"></i>
                ...
                USD/GBP</strong>
                <span class="sig-category">Intraday</span>
                </span>
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <img src="../assets/images/flag.png" class="bangla1img">
                USD/GBP</strong>
                <span class="sig-category">Long Term</span>
                </span>
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <strong>12:43</strong>
                                                        ...
                                                        <div class="row lhsize1 ml-0 mr-0 downborder">
                                                            <div class="col-md-5 col-sm-5 col">
                                                                <span class="left-side ">Buy at:</span>
                                                            </div>
                                                            <div class="col-md-7 col-sm-7 col text-md-right">
                                                                <span>1.2345</span>
                                                            </div>
                                            ...
                                            <div class="row fixed-gap15">
                                                <div class="col-md-12 text-center no-sm-p">
                                                    <a href="javascript:void(0)" target="_blank"><img
                                                            src="../assets/images/add/signal-add.png"
                                                            alt="Advertisement" class="sig-ad"></a>
                                                </div>
                                            </div>
                                            <div class="row fixed-gap15">
                                                <div class="col-md-6 gap-padding-fix">
                ...
                <strong>12:43</strong>
                                                        ...
                                                        <div class="row lhsize1 ml-0 mr-0 downborder">
                                                            <div class="col-md-5 col-sm-5 col">
                                                                <span class="left-side ">Buy Limit:</span>
                                                            </div>
                                                            <div class="col-md-7 col-sm-7 col text-md-right">
                                                                <span>1.2345</span>
                                                            </div>
                ...
                <strong>12:43</strong>
                                                        ...
                                                        <div class="row lhsize1 ml-0 mr-0 downborder">
                                                            <div class="col-md-5 col-sm-5 col">
                                                                <span class="left-side ">Sell Limit:</span>
                                                            </div>
                                                            <div class="col-md-7 col-sm-7 col text-md-right">
                                                                <span>1.2345</span>
                                                            </div>
                ...
                <strong>12:43</strong>
                                                        ...
                                                        <div class="row lhsize1 ml-0 mr-0 downborder">
                                                            <div class="col-md-5 col-sm-5 col">
                                                                <span class="left-side ">Buy Stop:</span>
                                                            </div>
                                                            <div class="col-md-7 col-sm-7 col text-md-right">
                                                                <span>1.2345</span>
                                                            </div>
                ...
                <strong>12:43</strong>
                                                        ...
                                                        <div class="row lhsize1 ml-0 mr-0 downborder">
                                                            <div class="col-md-5 col-sm-5 col">
                                                                <span class="left-side ">Sell Stop:</span>
                                                            </div>
                                                            <div class="col-md-7 col-sm-7 col text-md-right">
                                                                <span>1.2345</span>
                                                            </div>
                ...
                <strong>12:43</strong>
                                                        ...
                                                        <div class="row  text-center ">
                                                            <div class="col-md-12 text-center ">
                                                                <div class="lhsizeone">
                <span>
                <strong>FILLED <span>(</span> 70pips <span>)</span></strong>
                </span>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <div class="row signal-table">
                            <div class="col-md-12 ">
                                ...
                                <table class=" trades-table">
                                    <tr>
                                        <td colspan="5" class="abor3 text-center border-radius-top-3"
                                            style="font-size: 15px">Recent Closed Trades
                                        </td>
                                    </tr>
                                    <tr>
