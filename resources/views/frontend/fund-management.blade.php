...
@section('content')
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-0 col-md-8 offset-md-2 text_md_center res_md_mt_30">
                    <div class="infographic-image float-right">
    ...
    <section id="token" class="mt-5 no-dots wow fadeInUp" data-wow-duration="0.6s">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 offset-lg-0 col-md-8 offset-md-2 text_md_center res_md_mt_30">
                    <div class="infographic-image float-left">
                        <img src="assets/images/hexagons.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-7 col-md-12 col-sm-12 text_md_center">
    ...
    <section class="no-dots">
        ...
        <div class="container">
            <div class="pricing-plan card-group d-flex">
                ...
                @foreach($fundManagementPackages as $fundPackage)
                
                <div class="card business p-1">
                    <div class="card-header text-center pb-4 item" style="height: 80.2px;">
                        <h5 class="pt-3 text-white card-title"><i class="fab fa-accusoft"></i>{{ $fundPackage->title }}</h5>
                    </div>
                    <div class="card-body d-flex flex-column">
                        <ul class="list-unstyled text-center">
                            @foreach($fundPackage->details as $each)
                            <li>
                                {{ $each['key'] }}  {{ $each['value'] }}
                            </li>
                            @endforeach
                        </ul>
                        <a class="btn btn-lg btn-block btn-outline-light mt-auto" href="#">Get started</a>
                    </div>
                </div>
                @endforeach
            </div>
