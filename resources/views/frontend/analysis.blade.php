                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                            <div class="card-body">
                                <ul>
                                    ...
                                    <li><a href="fx-analysis-sub.html">Sub Category 1</a></li>
            ...
            <div class="col-lg-6 col-md-12 md-pl-1-half md-pr-1-half" id="seconddiv">
                <div class="mid-content position-relative">
                    ...
                    <div class="title-container">
                        <h2 class="forex-header-second"><span>FX Analysis</span></h2>
                    </div>
                    <div class="col-12 p-0 analysis-section">
                        @php
                            $data = array_chunk($analyses->toArray()['data'], 2);
                        @endphp
                                                ...
                                                <div class="col-md-9 md-pl-1-half toggle-adjust-right">
                                                    <div class="right-inner">
                                                        <h3>
                                                            ...
                                                            <span>{{ $row['first_name'] . ' ' . $row['last_name'] }} at {{ date('H:i', strtotime($row['created_at'])) }}</span>
                                                        ...
                                                        <div align=left style="font-size:13px">
                                                            ...
                                                            <a href="{{ url('/analysis/'.$row['slug']) }}" target="_blank" class="btn btn-footer-read pull-right"><span>Read More</span></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active show fade" id="recent">
                                    <div class="recent-analysis-container" data-simplebar>
                                        @include('partial.analysis.latest-analyses')
                                    </div>
                                </div>
                ...
                <div class="position-relative mt-2">
                    ...
                    <div class="container">
                        <div class="row helper">
                            ...
                            <div class="col-md-6">
                                <a href="fx-analysis.html" target="_blank">
