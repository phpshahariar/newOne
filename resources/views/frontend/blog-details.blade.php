        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 md-pl-1-half md-pr-1-half" id="seconddiv">
                    <div class="mid-content position-relative">
                        ...
                        <div class="title-container">
                            <h2 class="forex-header-second"><span>FX OFFICIAL Blog detail</span></h2>
                        </div>
                        ...
                        <div class="next-prev-post">
                            <div class="prev-post">
                                <a href="javascript:void(0)" class="btn btn-default custom-btn radius-2px"><i class="ion-ios-arrow-thin-left"></i> <span>Previous Blog Post</span></a>
                            </div>
                            <div class="next-post pull-right">
                                <a href="javascript:void(0)" class="btn btn-default custom-btn radius-2px"><span>Next Blog Post</span> <i class="ion-ios-arrow-thin-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 md-pl-1-half" id="thirddiv">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="analysis-discription">
                                                        <div class="right-info-container">
                                                            <h4 class="profile-name conurl"><a href="blog-detail.html" target="_blank">Forex Research</a></h4>
                    ...
                    <!-- Related Posts -->
                    <div class="position-relative">
                        <h4 class="trading-session-header mt-2">Related Blog Posts</h4>
                        <div class="toggleWrapper">
