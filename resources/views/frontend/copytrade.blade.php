...
@section('style')
    <style>
        .banner-consultency {
            background-image:url({{ asset('assets/images/hand.jpg') }});
            height: 585px;
            width:100%;
        ...
        .parallax-2 {
            /* The image used */
            background-image: url({{ asset('assets/images/hero-trading-station-web.jpg') }});
    ...
    <style>
        ...
        .section-gradient {
            background: #0c0e28;
            background-image: url({{ asset('assets/images/section_pattern.png') }});
            background-image: url({{ asset('assets/images/section_pattern.png') }}),
            -webkit-linear-gradient(top, #0c0e28 0%,#0c0e28 100%);
            background-image: url({{ asset('assets/images/section_pattern.png') }}),
            linear-gradient(to bottom, #0c0e28 0%,#0c0e28, #0c0e28 100%);
        }
...
@section('content')
            ...
            <div class="container">
                ...
                <div class="tab-content">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="pricing--content ">
                                    <div class="single_pricing_table text-center" data-animate="fadeInUp" data-delay=".2">
                                        ...
                                        <div class="pt_footer">
                                            <a class="btn btn-transparent btn-square" href="#">Purchase now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane show fade " id="annually" role="tabpanel">
                        ...
                        <div class="row justify-content-center">
                            @foreach($annually_packages as $annually)
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="pricing--content ">
                                        <div class="single_pricing_table text-center" data-animate="fadeInUp" data-delay=".2">
                                            <div class="pt_header">
                                                <div class="pt_price"><span>$ {{ $annually->price }}</span>&nbsp;<small>{{ ucfirst($annually->duration) }}</small></div>
                                                <h2>{{ $annually->title }}</h2>
                                            </div>
                                            <div class="pt_body">
                                                <div class="pt_feature karla">
                                                    <ul>
                                                    @foreach($annually->details as $each)
                                                        <li>{{ $each['key'] }}    {{ $each['value'] }}</li>
                                                    @endforeach
                                                    </ul>
                                                </div>
    ...
    <section id="whitepaper" class="small_pb small_pt p-0 no-dots wow fadeInUp" data-wow-duration="0.9s">
        <div class="parallax-2">
            <div class="container all-service">
                <div class="row small_space pt-5 mb-5 mt-0">
    ...
    <div class="section-full mobile-page-padding p-t80 p-b50 bg-cover wow fadeInUp" style="background-image:url({{ asset('assets/images/background/bg6.jpg') }});" data-wow-duration="1s">
        <div class="container">
            <div class="text-center mb-5 mt-4">
